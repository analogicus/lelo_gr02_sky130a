...
VL_INLINE_OPT void Vlng___024root___nba_sequent__TOP__0(Vlng___024root* vlSelf) {
    ...
    // Body
    vlSelf->cnt_out = ((IData)(vlSelf->reset) ? 0U : (IData)(vlSelf->counter__DOT__cnt_var));
...
#endif
            VL_FATAL_MT("../../rtl/Counter.v", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../../rtl/Counter.v", 3, "", "Active region did not converge.");
            }
...
void Vlng___024root___eval_debug_assertions(Vlng___024root* vlSelf) {
    ...
    // Body
    if (VL_UNLIKELY((vlSelf->osc_temp & 0xfeU))) {
        Verilated::overWidthError("osc_temp");}
