...
extern const VlUnpacked<CData/*1:0*/, 8> Vlng__ConstPool__TABLE_h4887ebb5_0;
extern const VlUnpacked<CData/*0:0*/, 8> Vlng__ConstPool__TABLE_h96aa6e1a_0;
extern const VlUnpacked<CData/*0:0*/, 8> Vlng__ConstPool__TABLE_hcd68096c_0;
extern const VlUnpacked<CData/*0:0*/, 8> Vlng__ConstPool__TABLE_h5b88da62_0;
...
VL_INLINE_OPT void Vlng___024root___ico_sequent__TOP__0(Vlng___024root* vlSelf) {
    ...
    __Vtableidx1 = 0;
    // Body
    __Vtableidx1 = (((IData)(vlSelf->start) << 2U) 
                    | (IData)(vlSelf->counter_fsm__DOT__state));
    vlSelf->counter_fsm__DOT__next_state = Vlng__ConstPool__TABLE_h4887ebb5_0
        [__Vtableidx1];
    vlSelf->reset_cnt = Vlng__ConstPool__TABLE_h96aa6e1a_0
        [__Vtableidx1];
    vlSelf->pwrupOsc = Vlng__ConstPool__TABLE_hcd68096c_0
        [__Vtableidx1];
    vlSelf->completed = Vlng__ConstPool__TABLE_h5b88da62_0
        [__Vtableidx1];
}
...
VL_INLINE_OPT void Vlng___024root___nba_sequent__TOP__0(Vlng___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->rst_n) {
        if ((3U == (IData)(vlSelf->counter_fsm__DOT__state))) {
            vlSelf->clk_cycles = vlSelf->cnt_out;
        }
        vlSelf->counter_fsm__DOT__state = vlSelf->counter_fsm__DOT__next_state;
    } else {
        vlSelf->clk_cycles = 0U;
        vlSelf->counter_fsm__DOT__state = 0U;
    }
    __Vtableidx1 = (((IData)(vlSelf->start) << 2U) 
                    | (IData)(vlSelf->counter_fsm__DOT__state));
    vlSelf->counter_fsm__DOT__next_state = Vlng__ConstPool__TABLE_h4887ebb5_0
...
#endif
            VL_FATAL_MT("../../rtl/FSM.v", 3, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("../../rtl/FSM.v", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../../rtl/FSM.v", 3, "", "Active region did not converge.");
            }
