...
N 370 30 380 30 {lab=PWRUP_1V8}
N 380 -0 450 0 {lab=VDD_1V8}
C {devices/ipin.sym} 370 0 0 0 {name=p1 lab=VDD_1V8}
C {devices/ipin.sym} 640 420 0 1 {name=p2 lab=VSS}
C {devices/ipin.sym} 370 30 0 0 {name=p3 lab=PWRUP_1V8}
