...
N 360 100 360 110 {lab=#net4}
N 360 100 550 100 {lab=#net4}
N 550 100 550 110 {lab=#net4}
N 450 90 450 100 {lab=#net4}
N 220 100 360 100 {lab=#net4}
N 220 100 220 110 {lab=#net4}
...
N 360 110 360 130 {lab=#net4}
N 220 110 220 130 {lab=#net4}
N 550 110 550 130 {lab=#net4}
...
C {devices/ipin.sym} 370 50 0 0 {name=p3 lab=PWRUP_1V8}
