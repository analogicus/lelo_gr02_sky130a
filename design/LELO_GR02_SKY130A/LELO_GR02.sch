...
C {devices/lab_pin.sym} 270 -320 0 0 {name=p5 sig_type=std_logic lab=VSS}
...
C {devices/lab_pin.sym} 630 -510 0 1 {name=p22 sig_type=std_logic lab=PWRUP_N_1V8
