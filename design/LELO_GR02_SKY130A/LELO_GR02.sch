...
C {devices/ipin.sym} 270 -510 0 0 {name=p3 lab=PWRUP_1V8}
...
C {devices/lab_pin.sym} 750 -510 0 1 {name=p22 sig_type=std_logic lab=PWRUP_B_1V8


}
C {devices/lab_pin.sym} 940 -290 0 0 {name=p1 sig_type=std_logic lab=PWRUP_N_1V8}
C {devices/lab_pin.sym} 940 -240 0 0 {name=p7 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 940 -320 0 0 {name=p8 sig_type=std_logic lab=VDD_1V8}
