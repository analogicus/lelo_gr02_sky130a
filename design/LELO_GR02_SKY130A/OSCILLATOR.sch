...
N -20 120 -20 210 {lab=VSS}
N -140 80 -120 80 {lab=VSS}
N -120 80 -120 120 {lab=VSS}
N -140 120 -120 120 {lab=VSS}
N -80 70 -60 70 {lab=VSS}
N -80 70 -80 110 {lab=VSS}
N -80 110 -60 110 {lab=VSS}
C {devices/ipin.sym} -280 -160 0 0 {name=p1 lab=PWRUP_B_1V8}
C {devices/opin.sym} 590 -60 0 0 {name=p2 lab=OSC_TEMP_1V8}
C {devices/ipin.sym} -280 -60 0 0 {name=p3 lab=PWRUP_N_1V8}
C {devices/ipin.sym} -280 -110 0 0 {name=p4 lab=VDD_1V8}
...
C {devices/lab_wire.sym} 430 40 3 0 {name=p10 lab=VDD_1V8}
C {JNW_TR_SKY130A/JNWTR_DFRNQNX1_CV.sym} 400 0 0 0 {name=x6 }
C {devices/lab_wire.sym} 460 -100 0 0 {name=p11 sig_type=std_logic lab=VDD_1V8}
C {devices/lab_wire.sym} 260 0 1 0 {name=p8 sig_type=std_logic lab=OTA_OUTPUT}
C {JNW_TR_SKY130A/JNWTR_CAPX4.sym} -220 100 2 0 {name=x13[3:0]}
...
C {devices/lab_wire.sym} 300 70 3 1 {name=p12 lab=VDD_1V8}
C {JNW_ATR_SKY130A/JNWATR_NCH_12C5F0.sym} 40 120 0 1 {name=x1 }
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} -180 80 0 0 {name=x2 }
