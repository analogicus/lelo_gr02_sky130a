...
C {devices/lab_wire.sym} 390 -100 0 0 {name=p14 sig_type=std_logic lab=VDD_1V8}
C {devices/lab_wire.sym} 360 40 3 0 {name=p11 sig_type=std_logic lab=VDD_1V8}
...
C {devices/lab_wire.sym} 115 50 3 0 {name=p10 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 580 -20 3 0 {name=p12 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 580 -130 3 1 {name=p13 sig_type=std_logic lab=VDD_1V8}
C {devices/lab_wire.sym} -80 120 3 0 {name=p15 sig_type=std_logic lab=VSS}
