...
N -400 -20 -400 -10 {lab=#net3}
N -430 -70 -420 -70 {lab=VSS}
N -400 -30 -400 -20 {lab=#net3}
...
C {devices/ipin.sym} -220 20 0 0 {name=p4 lab=VIN_P}
...
C {devices/ipin.sym} 150 20 0 1 {name=p11 lab=VIN_N}
