...
N 370 200 370 230 {lab=VSS}
N -400 250 -400 280 {lab=VSS}
N 250 170 330 170 {lab=V_IB}
N 250 120 250 170 {lab=V_IB}
...
N 370 230 370 310 {lab=VSS}
N 30 310 370 310 {lab=VSS}
N -320 120 250 120 {lab=V_IB}
N 370 310 410 310 {lab=VSS}
N 410 170 410 310 {lab=VSS}
...
C {cborder/border_xs.sym} -360 380 0 0 {
user="Group 2"
company=""}
...
C {LELO_ATR_SKY130A/LELOATR_LVT_PCH_12C5F0.sym} -100 -240 0 0 {name=x3[3:0]}
C {LELO_ATR_SKY130A/LELOATR_NCH_4C5F0.sym} -220 240 0 0 {name=x6[1:0]}
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_4C5F0.sym} -360 170 0 1 {name=x5[1:0]}
C {LELO_ATR_SKY130A/LELOATR_LVT_NCH_4C5F0.sym} 330 170 0 0 {name=x7[1:0]}
