...
N 450 50 480 50 {lab=#net3}
N 510 0 510 50 {lab=#net3}
N 450 0 480 0 {lab=#net3}
...
N 480 50 510 50 {lab=#net3}
N 480 -0 510 -0 {lab=#net3}
...
N 220 240 220 260 {lab=#net4}
N 370 -0 450 0 {lab=#net3}
...
C {devices/ipin.sym} 320 290 0 0 {name=p4 lab=VIN}
C {devices/ipin.sym} 590 290 0 1 {name=p5 lab=VIP}
C {devices/opin.sym} 640 210 0 0 {name=p6 lab=VOUT}
C {devices/lab_pin.sym} 180 250 0 0 {name=p7 sig_type=std_logic lab=VSS
}
...
C {devices/lab_pin.sym} 370 0 0 0 {name=p14 sig_type=std_logic lab=VDD_1V8
}
