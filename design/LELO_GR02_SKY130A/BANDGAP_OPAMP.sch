...
S {}
E {}
T {<- This transistor was selected because} 640 150 0 0 0.2 0.2 {}
T {<- These transistor was selected because } 760 280 0 0 0.2 0.2 {}
T {<- This transistor was selected because} 600 40 0 0 0.2 0.2 {}
T {<- These transistor was selected because } 590 410 0 0 0.2 0.2 {}
...
N 520 440 520 460 {lab=VSS}
N 220 440 220 460 {lab=VSS}
N 410 460 410 480 {lab=VSS}
N 220 460 340 460 {lab=VSS}
N 410 460 520 460 {lab=VSS}
...
N 550 450 550 460 {lab=VSS}
N 550 410 550 450 {lab=VSS}
N 190 410 190 460 {lab=VSS}
N 190 460 220 460 {lab=VSS}
N 280 360 280 410 {lab=bottom
}
N 220 350 220 380 {lab=bottom}
N 220 360 280 360 {lab=bottom}
...
N 220 340 220 350 {lab=bottom}
N 190 200 200 200 {lab=VSS}
N 190 200 190 300 {lab=VSS}
N 190 300 200 300 {lab=VSS}
N 180 250 190 250 {lab=VSS}
N 220 240 220 260 {lab=#net1}
N 440 0 520 0 {lab=VDD_1V8}
N 280 410 410 410 {lab=bottom}
N 620 210 750 210 {lab=VOUT}
N 750 210 770 210 {lab=VOUT}
N 350 290 390 290 {lab=VIP}
N 410 410 470 410 {lab=bottom}
N 470 410 480 410 {lab=bottom}
N 360 100 430 100 {lab=top}
N 340 460 410 460 {lab=VSS}
N 440 290 480 290 {lab=VSS}
N 570 290 610 290 {lab=VSS}
N 660 290 700 290 {lab=VIN}
N 160 250 180 250 {lab=VSS}
N 260 410 280 410 {lab=bottom}
...
C {devices/lab_pin.sym} 160 250 0 0 {name=p7 sig_type=std_logic lab=VSS
}
C {devices/lab_pin.sym} 410 480 0 0 {name=p8 sig_type=std_logic lab=VSS
}
...
C {JNW_TR_SKY130A/JNWTR_RPPO16.sym} 220 260 1 0 {name=x9 }
C {JNW_TR_SKY130A/JNWTR_RPPO16.sym} 220 160 1 0 {name=x10 }
...
C {JNW_ATR_SKY130A/JNWATR_NCH_4C1F2.sym} 390 290 0 0 {name=x1 }
C {JNW_ATR_SKY130A/JNWATR_NCH_4C1F2.sym} 660 290 0 1 {name=x2 }
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 470 160 0 1 {name=x3 }
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 580 160 0 0 {name=x4 }
C {JNW_ATR_SKY130A/JNWATR_NCH_2C5F0.sym} 480 410 0 0 {name=x5 }
C {JNW_ATR_SKY130A/JNWATR_NCH_2C5F0.sym} 260 410 0 1 {name=x6 }
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 480 50 0 0 {name=x7 }